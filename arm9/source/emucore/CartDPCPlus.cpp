...
{
  myImage = new uInt8[32*1024]; // Size is always 32k
  memcpy(myImage, image, size);

  // Pointer to the program ROM (24K @ 0 byte offset)
  myProgramImage = myImage + MEM_3KB;

  // Pointer to the display RAM
  myDisplayImage = myDPCRAM + MEM_3KB;

  // Pointer to the Frequency ROM (1K @ 28K offset)
  myFrequencyImage = myDisplayImage + MEM_4KB;

  // Copy DPC display data to Harmony RAM
  memcpy(myDisplayImage, myProgramImage + MEM_24KB, MEM_5KB);
