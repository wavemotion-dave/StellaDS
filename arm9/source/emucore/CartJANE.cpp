...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
CartridgeJANE::CartridgeJANE(const uInt8* image)
{
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
CartridgeJANE::~CartridgeJANE()
{
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
const char* CartridgeJANE::name() const
{
  return "JANE";
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void CartridgeJANE::reset()
{
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void CartridgeJANE::install(System& system)
{
  mySystem = &system;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
uInt8 CartridgeJANE::peek(uInt16 address)
{
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void CartridgeJANE::poke(uInt16 address, uInt8)
{
  address = address & 0x0FFF;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
inline  void CartridgeJANE::bank(uInt16 bank)
{ 
