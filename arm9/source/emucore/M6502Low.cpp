...
uInt32 myExecutionStatus                __attribute__((section(".dtcm")));   // 
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
ITCM_CODE uInt8 M6502Low::peek_CDFJ(uInt16 address)
{
  ++gSystemCycles;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
inline uInt8 M6502Low::peek_CDFJPC(uInt16 address)
{
  ++gSystemCycles;
  return myDPCptr[address & 0xFFF];
}
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
inline void M6502Low::poke_CDFJ(uInt16 address, uInt8 value)
{
  ++gSystemCycles;
...
inline void M6502Low::poke_small(uInt8 address, uInt8 value)
{
    ++gSystemCycles;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void M6502Low::execute_CDFJ(uInt16 number)
{
    uInt16 operandAddress;
...
inline uInt8 M6502Low::peek_DataStreamPlus(uInt8 address)
{
  if (address == myAmplitudeStream) return myCartCDF->peekMusic();
...
inline uInt16 M6502Low::peek_JumpStreamPlus(uInt8 address)
{
  uInt16 result;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void M6502Low::execute_CDFJPlus(uInt16 number)
{
    //uInt32 fast_loop = number;
    uInt16 operandAddress;
