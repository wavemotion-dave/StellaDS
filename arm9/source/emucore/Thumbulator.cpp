  ...
  while (1)
  {
      ...
      switch (decoded)
      {
          ...
          case Op::ldrb1:
                rd=(inst>>0)&0x07;
                rn = ((inst>>3) & 0x0007);
                rb=read_register(rn)+((inst>>6)&0x1F);
                if(rb&1)
                {
          ...
          case Op::ldr3:
                ...
                rb+=ra;
                reg_sys[rn]=readROM32(rb);   // This one will always be fetched from ROM as it's based on the PC
              break;
          ...
          case Op::add2_r0:
                ...
                // ------------------------------------------------------------------------------------------------------
#ifdef SAFE_THUMB              
                if (bSafeThumb) {vFlag = do_add_vflag(ra,-rb,rc); do_cflag(ra,rb,0);}
#endif              
              break;
          case Op::add2_r1:
