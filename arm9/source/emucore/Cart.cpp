...
static const CartInfo table[] = 
{
    ...
    {"f1a0a23e6464d954e3a9579c4ccd01c8",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  0},    // Alien (1982).bin
    {"956496f81775de0b69a116a0d1ad41cc",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  0},    // Alien (1982).bin
    ...
    {"d0b9df57bfea66378c0418ec68cfe37f",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_FF,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  0},    // Beany Bopper (1982).bin
    {"6a9e0c72fab92df70084eccd9061fdbd",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_FF,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  0},    // Beany Bopper (1982).bin
    ...
    {"b8ed78afdb1e6cfe44ef6e3428789d5f",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  4},    // Bermuda Triangle (1982).bin
    {"36c993dc328933e4dd6374a8ffe224f4",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  PAL,   47,    245,    51,   0,  0},    // Bermuda Triangle (1982) (PAL).bin
    {"136f75c4dd02c29283752b7e5799f978",  "BERZRK", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  0},    // Berzerk (1982).bin
    ...
    {"73aa02458b413091ac940c0489301710",  "CRAPOT", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  51,    245,   100,   4, 17},    // Crackpots (1983) (PAL).bin
    {"7f54fa6aa824001af415503c313262f2",  "CRAPOT", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  51,    245,   100,   4, 17},    // Crackpots (1983) (PAL).bin
    {"2825f4d068feba6973e61c84649489fe",  "CRAPOT", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  51,    245,   100,   4, 17},    // Crackpots (1983) (PAL).bin
    {"f3c431930e035a457fe370ed4d230659",  "CRAPOT", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  51,    245,   100,   4, 17},    // Crackpots (1983) (PAL).bin
    ...
    {"f91fb8da3223b79f1c9a07b77ebfa0b2",  "??????", "4K",   CTR_PADDLE1,   SPEC_NONE,      MODE_NO,   1,  1,  ANA0_9,  NTSC,  34,    210,   100,   0,  0},    // Demons to Diamonds (1982).bin
    {"bf84f528de44225dd733c0e6a8e400a0",  "??????", "4K",   CTR_PADDLE1,   SPEC_NONE,      MODE_NO,   1,  1,  ANA0_9,  NTSC,  34,    210,   100,   0,  0},    // Demons to Diamonds (1982).bin
    {"d62283aed0f4199adb2333de4c263e9c",  "??????", "4K",   CTR_PADDLE1,   SPEC_NONE,      MODE_NO,   1,  1,  ANA0_9,  PAL,   44,    245,    59,   0,  2},    // Demons to Diamonds (1982) (PAL).bin
    ...
    {"24d9a55d8f0633e886a1b33ee1e0e797",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_FF,   1,  1,  ANA1_0,  NTSC,  30,    210,    82,   0,  0},    // Dragon Defender.bin
    ...
    {"dbc8829ef6f12db8f463e30f60af209f",  "??????", "4K",   CTR_PADDLE0,   SPEC_NONE,      MODE_FF,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  0},    // Encounter at L-5 (1982).bin
    ...
    {"81f4f0285f651399a12ff2e2f35bab77",  "??????", "AR",   CTR_LJOY,      SPEC_AR,        MODE_NO,   0,  1,  ANA1_0,  NTSC,  34,    200,   100,   2,  0},    // Escape from the Mindmaster (1982).bin
    {"c9e721eb29c940c2e743485b044c0a3f",  "??????", "AR",   CTR_LJOY,      SPEC_AR,        MODE_NO,   0,  1,  ANA1_0,  PAL,   58,    230,   100,   0,  0},    // Escape from the Mindmaster (1982) (PAL).bin
    ...
    {"b8865f05676e64f3bec72b9defdacfa7",  "??????", "2K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   0,  0,  ANA1_0,  NTSC,  34,    194,   100,   0,  4},    // Fishing Derby (1980).bin
    {"13ccc692f111d52fec75d83df16192e2",  "??????", "2K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   0,  0,  ANA1_0,  NTSC,  34,    194,   100,   0,  4},    // Fishing Derby (1980).bin
    {"dea0ade296f7093e71185e802b500db8",  "??????", "2K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   0,  0,  ANA1_0,  NTSC,  34,    194,   100,   0,  4},    // Fishing Derby (1980).bin
    {"74023e0f2e739fc5a9ba7caaeeee8b6b",  "??????", "2K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   0,  0,  ANA1_0,  NTSC,  34,    194,   100,   0,  4},    // Fishing Derby (1980).bin
    ...
    {"4ca73eb959299471788f0b685c3ba0b5",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   4,  5},    // Frostbite (1983).bin
    {"f4469178cd8998cb437fa110a228eaca",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   4,  5},    // Frostbite (1983).bin
    {"c225379e7c4fb6f886ef9c8c522275b4",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   4,  5},    // Frostbite (1983).bin
    {"c6ae21caceaad734987cb24243793bd5",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   4,  5},    // Frostbite (1983).bin
    {"adb79f9ac1a633cdd44954e2eac14774",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   4,  5},    // Frostbite (1983).bin
    {"5a93265095146458df2baf2162014889",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  PAL,   52,    245,   100,   4,  5},    // Frostbite (1983) (PAL).bin    
    {"25a21c47afe925a3ca0806876a2b4f3f",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  PAL,   58,    245,   100,   4,  5},    // Frostbite (1983) (PAL).bin    
    ...
    {"718ee85ea7ec27d5bea60d11f6d40030",  "??????", "F6",   CTR_LJOY,      SPEC_NONE,      MODE_FF,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  0},    // Ghostbusters II (1992).bin
    ...
    {"0c4e5087d748c67a81d114b3a9b5a112",  "??????", "F8",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  3},    // Go Fish - Extended.bin
    {"787a2faebadc670a887a0e2483b8f034",  "??????", "F8",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  3},    // Go Fish.bin
    ...
    {"700a786471c8a91ec09e2f8e47f14a04",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  4},    // Hard Head (Prototype).bin
    ...
    {"260c787e8925bf3649c8aeae5b97dcc0",  "??????", "4K",   CTR_PADDLE0,   SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  0},    // Hell Driver (ITT Family Games, Thomas Jentzsch) (NTSC).bin
    ...
    {"129d6c4cda0cd883faac4ae20499e0c2",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  0},    // Hellway
    ...
    {"b4e2fd27d3180f0f4eb1065afc0d7fc9",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  0},    // London Blitz (1983).bin
    ...
    {"e6e5bb0e4f4350da573023256268313d",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_FF,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0, 12},    // Missile Control (AKA Raketen-Angriff) (Ariola, Thomas Jentzsch).bin
    ...
    {"5641c0ff707630d2dd829b26a9f2e98f",  "??????", "F8",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  33,    210,   100,   0,  0},    // Motocross Racer (1983).bin
    {"de0173ed6be9de6fd049803811e5f1a8",  "??????", "F8",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  33,    210,   100,   0,  0},    // Motocross Racer (1983).bin
    {"f5a2f6efa33a3e5541bc680e9dc31d5b",  "??????", "F8",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  PAL,   52,    245,   100,   0,  0},    // Motocross Racer (1983) (PAL).bin
    {"a20b7abbcdf90fbc29ac0fafa195bd12",  "??????", "F8",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  PAL,   52,    245,   100,   0,  0},    // Motocross Racer (1983) (PAL).bin
    ...
    {"a189f280521f4e5224d345efb4e75506",  "??????", "F8",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  4},    // Obelix (Atari, Thomas Jentzsch) (NTSC).bin
    ...
    {"245f07c8603077a0caf5f83ee6cf8b43",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,    95,   0,  2},    // Parachute (HomeVision, Thomas Jentzsch) (NTSC).bin
    ...
    {"62f74a2736841191135514422b20382d",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  0},    // Pharaoh's Curse (1983).bin
    {"3577e19714921912685bb0e32ddf943c",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  PAL,   57,    245,    99,   0,  0},    // Pharaoh's Curse (1983) (PAL).bin
    {"a69f5b1761a8a11c98e706ec7204937f",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  PAL,   47,    245,   100,   0,  0},    // Pharaoh's Curse (1983) (PAL).bin
    ...
    {"c4060a31d61ba857e756430a0a15ed2e",  "??????", "F6",   CTR_LJOY,      SPEC_NONE,      MODE_FF,   1,  1,  ANA1_0,  NTSC,  30,    210,    90,   0,  0},    // Pick'n Pile (NTSC by Thomas Jentzsch).bin
    ...
    {"44f71e70b89dcc7cf39dfd622cfb9a27",  "??????", "3F",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  0},    // Polaris (1983).bin
    {"203049f4d8290bb4521cc4402415e737",  "??????", "3F",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  PAL,   52,    245,   100,   0,  5},    // Polaris (1983) (PAL).bin
    {"a4ff39d513b993159911efe01ac12eba",  "??????", "F8",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  0},    // Pole Position (1983).bin    
    {"5f39353f7c6925779b0169a87ff86f1e",  "??????", "F8",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   4,  1},    // Pole Position (1983)[alt].bin
    {"3225676f5c0c577aeccfaa7e6bedd765",  "??????", "F8",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  0},    // Pole Position (1983).bin    
    {"5da8fd0b5ed33a360bff37f8b5d0cd58",  "??????", "F8",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  0},    // Pole Position (1983).bin    
    {"b56264f738b2eb2c8f7cf5a2a75e5fdc",  "??????", "F8",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  PAL,   52,    245,   100,   3,  0},    // Pole Position (1983) (PAL).bin    
    ...
    {"a4ecb54f877cd94515527b11e698608c",  "??????", "F8",   CTR_LJOY,      SPEC_NONE,      MODE_FF,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  4},    // Saboteur (1983).bin
    {"64fab9d15df937915b1c392fc119b83b",  "??????", "F8",   CTR_LJOY,      SPEC_NONE,      MODE_FF,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  4},    // Saboteur (1983).bin
    {"350e0f7b562ec5e457b3f5af013648db",  "??????", "F8",   CTR_LJOY,      SPEC_NONE,      MODE_FF,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  4},    // Saboteur (1983).bin
    {"4e01d9072c500331e65bb87c24020d3f",  "??????", "F8",   CTR_LJOY,      SPEC_NONE,      MODE_FF,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  4},    // Saboteur (1983).bin
    {"1ec57bbd27bdbd08b60c391c4895c1cf",  "??????", "F8",   CTR_LJOY,      SPEC_NONE,      MODE_FF,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  4},    // Saboteur (1983).bin
    ...
    {"624e0a77f9ec67d628211aaf24d8aea6",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   2,  2},    // Sea Hawk (1983).bin
    {"07f42847a79e4f5ae55cc03304b18c25",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   2,  2},    // Sea Hawk (1983).bin
    {"3fd53bfeee39064c945a769f17815a7f",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   2,  2},    // Sea Hawk (1983).bin
    {"07f42847a79e4f5ae55cc03304b18c25",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   2,  2},    // Sea Hawk (1983).bin
    {"74d072e8a34560c36cacbc57b2462360",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  PAL,   38,    245,    85,   2,  0},    // Sea Hawk (1983) (PAL).bin
    {"1b8d35d93697450ea26ebf7ff17bd4d1",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  PAL,   38,    245,    85,   2,  0},    // Sea Hawk (1983) (PAL).bin
    ...
    {"5305f69fbf772fac4760cdcf87f1ab1f",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  4},    // Ski Run (2600 Screen Search Console).bin
    ...
    {"97842fe847e8eb71263d6f92f7e122bd",  "??????", "4K",   CTR_PADDLE0,   SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  5},    // Solar Storm (1983).bin
    {"e6de4ef9ab62e2196962aa6b0dedac59",  "??????", "4K",   CTR_PADDLE0,   SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  PAL,   60,    245,   100,   0,  0},    // Solar Storm (1983) (PAL).bin
    ...
    {"44ca1a88274ff55787ed1763296b8456",  "??????", "F4",   CTR_LJOY,      SPEC_NONE,      MODE_FF,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  4},    // SpaceGame-Final.bin
    {"45040679d72b101189c298a864a5b5ba",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_FF,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  3},    // SpaceMaster X-7 (1983).bin
    {"bd551ff1264f5c367a3ad7cf0d2f266c",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_FF,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  3},    // SpaceMaster X-7 (1983).bin
    {"e14feddeb82f5160ed5cf9ca4078e58d",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_FF,   1,  1,  ANA1_0,  PAL,   60,    245,   100,   0,  3},    // SpaceMaster X-7 (1983) (PAL).bin
    ...
    {"6216bef66edceb8a24841e6065bf233e",  "??????", "2K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  31,    210,   100,   0,  0},    // Splatform 2600 (v1.01).bin
    ...
    {"d69559f9c9dc6ef528d841bf9d91b275",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_FF,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  0},    // StarMaster (1982).bin
    {"d62d7d1a974c31c5803f96a8c1552510",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_FF,   1,  1,  ANA1_0,  PAL,   52,    245,   100,   0,  0},    // StarMaster (1982) (PAL).bin
    {"348615ffa30fab3cec1441b5a76e9460",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_FF,   1,  1,  ANA1_0,  PAL,   52,    245,   100,   0,  0},    // StarMaster (1982) (PAL).bin
    {"73c839aff6a055643044d2ce16b3aaf7",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_FF,   1,  1,  ANA1_0,  PAL,   52,    245,   100,   0,  0},    // StarMaster (1982) (PAL).bin
    {"00ce76ad69cdc2fa36ada01ae092d5a6",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_FF,   1,  1,  ANA1_0,  PAL,   52,    245,   100,   0,  0},    // StarMaster (1982) (PAL).bin
    ...
    {"f1eeeccc4bba6999345a2575ae96508e",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_FF,   1,  1,  ANA2_5,  PAL,   52,    245,   100,   0,  0},    // Steeplechase (1983 Video Gems) (PAL).bin
    {"0b8d3002d8f744a753ba434a4d39249a",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_FF,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  0},    // Stellar Track (1980).bin
    ...
    {"d45ebf130ed9070ea8ebd56176e48a38",  "??????", "4K",   CTR_PADDLE3,   SPEC_NONE,      MODE_NO,   1,  1,  ANA1_6,  NTSC,  34,    210,   100,   0,  0},    // Tac-Scan (1982).bin
    {"4892b85c248131d6a42c66a4163a40d0",  "??????", "4K",   CTR_PADDLE3,   SPEC_NONE,      MODE_NO,   1,  1,  ANA1_6,  NTSC,  34,    210,   100,   0,  0},    // Tac-Scan (1982).bin
    {"6aca52e11b597ab84b33d5252e1cd9d1",  "??????", "4K",   CTR_PADDLE3,   SPEC_NONE,      MODE_NO,   1,  1,  ANA1_6,  NTSC,  34,    210,   100,   0,  0},    // Tac-Scan (1982).bin
    {"06e5dc181a8eda1c31cc7c581c68b6ef",  "??????", "4K",   CTR_PADDLE3,   SPEC_NONE,      MODE_NO,   1,  1,  ANA1_6,  PAL,   59,    245,   100,   0,  0},    // Tac-Scan (1982) (PAL).bin
    ...
    {"c032c2bd7017fdfbba9a105ec50f800e",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  0},    // Thwocker (1984).bin
    ...
    {"81414174f1816d5c1e583af427ac89fc",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,    82,   2,  2},    // Treasure Below (Video Gems, Thomas Jentzsch) (NTSC).bin
    ...
    {"73e66e82ac22b305eb4d9578e866236e",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  0},    // Unknown Datatech Game.bin
    ...
    {"ee681f566aad6c07c61bbbfc66d74a27",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  0},    // UnknownActivision1_NTSC.bin
    ...
    {"45abcf993b65a9a1bbb49a019d5556dc",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  32,    215,    73,   0,  0},    // Walker (Alt).bin
    ...
    {"0cdd9cc692e8b04ba8eb31fc31d72e5e",  "??????", "F8",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  2},    // Wing War (Imagic, Thomas Jentzsch) (NTSC).bin
    ...
    {"87f020daa98d0132e98e43db7d8fea7e",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  0},    // Worm War I (1982).bin
    {"007d18dedc1f0565f09c42aa61a6f585",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  NTSC,  34,    210,   100,   0,  0},    // Worm War I (1982).bin
    {"fb531febf8e155328ec0cd39ef77a122",  "??????", "4K",   CTR_LJOY,      SPEC_NONE,      MODE_NO,   1,  1,  ANA1_0,  PAL,   55,    245,   100,   0, -9},    // Worm War I (1982) (PAL).bin
