...
class Thumbulator
{
  ...
  private:
    ...
    enum class Op : uInt8 {
      ...
      cmp1_r0,      cmp1_r1,    cmp1_r2,    cmp1_r3,    cmp1_r4,    cmp1_r5,    cmp1_r6,    cmp1_r7,    cmp2,       cmp2_r2,    // 40
      cmp2_r3,      cmp3,       cps,        cpy,        eor,        ldmia,      ldr1_r0,    ldr1_r1,    ldr1_r2,    ldr1_r3,    // 50
      ldr1_r4,      ldr1_r5,    ldr1_r6,    ldr1_r7,    ldr2,       mov1z,      ldr4_r0,    ldr4_r1,    ldr4_r2,    ldr4_r3,    // 60
      ldr4_r4,      ldr4_r5,    ldr4_r6,    ldr4_r7,    ldrb1,      ldrb2,      ldrh1,      ldrh2,      ldrsb,      ldrsh,      // 70
      lsl1,         lsl1_rb,    lsl2,       lsr1,       lsr2,       mov1,       mov2,       mov3,       mov3_r15,   mul,        // 80
      mvn,          neg,        orr,        pop,        push,       rev,        rev16,      revsh,      ror,        sbc,        // 90
      setend,       stmia,      str1,       str2,       str3,       str3_r2,    str3_r3,    strb1,      strb2,      strh1,      // 100
      strh2,        sub1,       sub2,       sub3,       sub4,       swi,        sxtb,       sxth,       tst,        uxtb,       // 110
