...
#ifndef CartridgeDFSCSC_HXX
#define CartridgeDFSCSC_HXX
...
/**
  Cartridge class used for 128K banked DF games with 128 bytes of extra SUPER RAM
*/
class CartridgeDFSC : public Cartridge
{
  public:
    ...
    */
    CartridgeDFSC(const uInt8* image);
